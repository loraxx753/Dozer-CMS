		...
		'js' => array(
			'hallo' => array(
				'files' => array(
					...
					'hallo/hallo.js',
					// The toolbar group
					'hallo/toolbar/contextual.js',
					'hallo/toolbar/fixed.js',
					// The widgets group
					'hallo/widgets/button.js',
					'hallo/widgets/dropdownbutton.js',
					// Alllllllll the plugins
					'hallo/plugins/annotate.js',
					'hallo/plugins/blacklist.js',
					'hallo/plugins/block.js',
					'hallo/plugins/cleanhtml.js',
					'hallo/plugins/halloformat.js',
					'hallo/plugins/headings.js',
					'hallo/plugins/html.js',
					'hallo/plugins/indicator.js',
					'hallo/plugins/justify.js',
					'hallo/plugins/link.js',
					'hallo/plugins/lists.js',
					'hallo/plugins/overlay.js',
					'hallo/plugins/reundo.js',
					'hallo/plugins/toolbarlinebreak.js',
					// The extra plugins for the image uploader
					'hallo/plugins/image/current.js',
					'hallo/plugins/image/suggestions.js',
					'hallo/plugins/image/upload.js',
					'hallo/plugins/image/search.js',
					'hallo/plugins/image.js',
